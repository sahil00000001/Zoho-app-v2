...
function LeaveCard({ leave, leaveTypeIndex }: { leave: CalendarLeave; leaveTypeIndex: number }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-4 hover:shadow-md transition-all hover:-translate-y-0.5 flex flex-col gap-3">
      {/* Header */}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Manage your leave requests and view team availability</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-2xl px-3 py-2">
              <button onClick={prevMonth} className="w-7 h-7 rounded-xl hover:bg-gray-100 flex items-center justify-center text-gray-500 transition-colors">
              ...
              <button onClick={nextMonth} className="w-7 h-7 rounded-xl hover:bg-gray-100 flex items-center justify-center text-gray-500 transition-colors">
            ...
            <div className="relative flex-1 min-w-[180px] max-w-xs">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-400 bg-white"
              />
            </div>
            ...
            {!calLoading && (
              <div className="ml-auto flex items-center gap-2 text-sm text-gray-500">
                <span className="font-black text-lg text-gray-900">{filteredCalLeaves.length}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-4 items-start">
              ...
              <div>
                ...
                {filteredCalLeaves.length === 0 ? (
                  ...
                  /* ── List view ── */
                  <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                    <div className="grid text-[10px] font-bold text-gray-400 uppercase tracking-widest px-4 py-3 border-b border-gray-100 bg-gray-50"
                  ...
                  <div className="space-y-3">
                    {filteredCalLeaves.map(l => {
                      ...
                      const days = daysBetween(l.startDate, l.endDate);
                      return (
                        <div key={l.id} className="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-md transition-all">
